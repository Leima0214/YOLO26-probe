#!/usr/bin/env python3
"""Train YOLOv8n baseline. See train_baseline_yolo26n.py for full usage."""
import argparse, sys
...
if __name__ == "__main__":
    ...
    YOLO("yolov8n.pt").train(data=args.data, epochs=args.epochs, imgsz=args.imgsz, batch=args.batch,
