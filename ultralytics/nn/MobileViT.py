...
class MobileViTBlock(nn.Module):
    def __init__(self, channel, out_channel, dim, depth, kernel_size, patch_size, mlp_dim, dropout=0.0):
        super().__init__()
        ...
        self.transformer = Transformer(dim, depth, 4, 8, mlp_dim, dropout=0.0)
