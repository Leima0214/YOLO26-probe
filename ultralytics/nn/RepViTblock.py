...
class RepVGGDW(torch.nn.Module):
    def __init__(self, ed) -> None:
        ...
        self.dim = ed  # 详细改进流程和操作，请关注B站博主：Ai学术叫叫兽 er,畅享一对一指点迷津，已指导无数家人拿下学术硕果！！！
...
class RepViTblock(nn.Module):
        ...
        if stride == 2:
            ...
            self.channel_mixer = Residual(
                nn.Sequential(
                    ...
                    nn.GELU()
                    if use_hs
                    else nn.GELU(),  # 详细改进流程和操作，请关注B站博主：Ai学术叫叫兽 er,畅享一对一指点迷津，已指导无数家人拿下学术硕果！！！
                    # pw-linear
    ...
    # 详细改进流程和操作，请关注B站博主：AI学术叫叫兽 #详细改进流程和操作，请关注B站博主：Ai学术叫叫兽 er,畅享一对一指点迷津，已指导无数家人拿下学术硕果！！！
